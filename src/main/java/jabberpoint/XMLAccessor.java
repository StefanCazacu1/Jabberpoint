...
public final class XMLAccessor implements AccessorStrategy
{
     ...
     */
    @Override
    public void loadFile(final Presentation presentation, final String filename) throws IOException
    {
        try
        {
            presentation.clear();
     ...
     */
    @Override
    public void saveFile(final Presentation presentation, final String filename) throws IOException
    {
        try
        {
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
